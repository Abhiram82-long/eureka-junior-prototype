...
router.get('/stats', requireAuth, async (req, res) => {
    try {
        ...
        // Filter recent searches for week and month counts
        const searchesThisWeek = recentSearches.filter(search => 
            new Date(search.created_at) >= weekAgo
        ).length;
        
        const searchesThisMonth = recentSearches.filter(search => 
